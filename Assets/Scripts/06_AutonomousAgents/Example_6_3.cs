...
public class Example_6_3 : MonoBehaviour
{

	public Vehicle_6_3 Vehicle_6_3;

	// Use this for initialization
	void Start () {
		Vehicle_6_3 = new Vehicle_6_3(8, 4.5f);
	}
	
	// Update is called once per frame
	void Update () {
		Vehicle_6_3.update();
		Vehicle_6_3.seek(Vehicle_6_3.wander());
		Vehicle_6_3.display();
		//Vehicle_6_3.CheckEdges();
	}
}

public class Vehicle_6_3
{
	Vector3 location;
	Vector3 velocity;
	...
	public Vehicle_6_3(float _x, float _y) {
