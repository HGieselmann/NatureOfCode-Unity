...
public class Example_2_4 : MonoBehaviour
{
	...
	private Vector3 friction = new Vector3(0,0,0);
	...
	void Start ()
	{
		for (int i = 0; i < movers.Length; i++)
		{
			...
			movers[i] = new Example_2_4_Mover(RandMass[i], 0, 9f);
