...
public class Example_2_2 : MonoBehaviour
{
	...
	void Start ()
	{
		for (int i = 0; i < movers.Length; i++)
		{
			...
			movers[i] = new Example_2_2_Mover(Rand, 0, 9f);
			...
			spheres[i].transform.localScale = new Vector3(Rand,Rand,Rand);
		}
