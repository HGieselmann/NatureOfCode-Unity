...
public class Example_3_8 : MonoBehaviour
{

	[SerializeField] static int NoOfSpheres = 16;
	private Oscillator_3_8[] oscillators = new Oscillator_3_8[NoOfSpheres];
	...
	void Start ()
	{
		...
		{
			oscillators[i] = new Oscillator_3_8(i,angleMult);
...
public class Oscillator_3_8 : MonoBehaviour
{
	...
	public Oscillator_3_8(int i, float angleMult)
	{
